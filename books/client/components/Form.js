  ...
  const handleSubmit = async (e) => {
    ...
    if (props.title === "New Estimate" || props.title === "New Sales Order") {
      ...
      if (props.title === "New Estimate") {
        await Estimates.addEstimate(data).then((data)=>{
          alert("Created Succesfully")
        })
        .catch((err)=>{alert("All fields are required")})
      
      } else if (props.title === "New Sales Order") {
        await Sales.addSales(data).then((data)=>{
          alert("Created Succesfully")
        })
        .catch((err)=>{alert("All fields are required")})
      ...
      console.log(data);
      await Invoices.addInvoice(data).then((data)=>{
        alert("Created Succesfully")
      })
      .catch((err)=>{alert("All fields are required")})
    }
                      ...
                      <Grid item xs={3} sm={3}>
                        ...
                        >
                          ...
                          >
                            ...
                            {props.items && props.items.map((val, index) => (
